<nav class="navbar navbar-expand-sm navbar-light bg-light sticky-top">
    <div class="container">
        <a class="navbar-brand" href="main.php"><img src="image/favicon.jpg" width="30" height="30" class="rounded-circle">Blood Donation and Request Platform for Nigerian Hospitals</a>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link btn btn-light" href="about.php">About</a>
            </li>
            <li class="nav-item">
