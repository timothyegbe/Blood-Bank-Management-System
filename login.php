    ...
    <div class="row justify-content-center">
      <div class="col-lg-4 col-md-5 col-sm-6 col-xs-7 mb-5">
        ...
        <div class="card rounded">
          ...
          <div class="tab-content">
            <div class="tab-pane container active" id="hospitals">
              <form action="file/hospitalLogin.php" class="login-form" method="post">
                ...
                <input type="email" name="hemail" placeholder="Hospital Email" class="form-control mb-4" required>

                <label class="text-muted font-weight-bold">Hospital Password</label>
                <input type="password" name="hpassword" placeholder="Hospital Password" class="form-control mb-4" required>
            ...
            <div class="tab-pane container fade" id="receivers">
              <form action="file/receiverLogin.php" class="login-form" method="post">
                <label class="text-muted font-weight-bold">Donor or Requester Email</label>
                <input type="email" name="remail" placeholder="Donor or Requester Email" class="form-control mb-4" required>

                <label class="text-muted font-weight-bold">Donor or Requester Password</label>
                <input type="password" name="rpassword" placeholder="Donor or Requester Password" class="form-control mb-4" required>
          ...
          <a href="register.php" class="text-center mb-4 d-block" title="Click here">Need an account?</a>
        </div>
